...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ResolveEntraID\functions", "$global:testroot\..\ResolveEntraID\internal\functions"),
	
	[string]
	$ModuleName = "ResolveEntraID",
...
$CommandPath = @(
    "$global:testroot\..\ResolveEntraID\functions"
    "$global:testroot\..\ResolveEntraID\internal\functions"
)
