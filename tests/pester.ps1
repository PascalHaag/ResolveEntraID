...
Remove-Module ResolveEntraID -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ResolveEntraID\ResolveEntraID.psd1"
Import-Module "$PSScriptRoot\..\ResolveEntraID\ResolveEntraID.psm1" -Force
